...
//     else
//     {
//         cout << "Yes target is present in the array & it's last occurance index is " << indexOftarget << ".";
//     }
...
int main()
{
    int arr[] = {2, 3, 4, 4, 6, 7, 8, 9};
    int size = 8;
    int target = 4;
    auto ans2 = upper_bound(arr, arr + 8,target);

    cout << "Yes target is present in the array & it's last occurances index is " << ans2 - arr-1 << ".";
